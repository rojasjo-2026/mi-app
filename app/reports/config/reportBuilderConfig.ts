...
export const REPORT_SOURCES: Array<{
  ...
  {
    key: "follow-ups",
    title: REPORT_SOURCE_CONFIG_BY_KEY["follow-ups"].label,
    label: REPORT_SOURCE_CONFIG_BY_KEY["follow-ups"].label,
    description: REPORT_SOURCE_CONFIG_BY_KEY["follow-ups"].description,
    badge: "Activo",
  },
];
