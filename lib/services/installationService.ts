...
const INSTALLATION_ACTIVITY_FIELDS: InstallationActivityField[] = [
  ...
  },
  {
    ...
    title: "Monto final de instalación actualizado",
    description: "Se actualizó el monto final de la instalación.",
    category: "FINANCE",
    visibility: "FINANCE_ONLY",
    action: "UPDATED",
    getValue: (source) =>
      source ? decimalToNumber(source.final_amount as never) : null,
  },
  {
    fieldName: "cost_amount",
    title: "Costo interno de instalación actualizado",
    description: "Se actualizó el costo interno de la instalación.",
    category: "FINANCE",
    visibility: "FINANCE_ONLY",
    action: "UPDATED",
    getValue: (source) =>
      source ? decimalToNumber(source.cost_amount as never) : null,
  },
  {
    fieldName: "billing_status",
    title: "Estado de facturación actualizado",
    description: "Se actualizó el estado de facturación de la instalación.",
    category: "FINANCE",
    visibility: "FINANCE_ONLY",
    action: "UPDATED",
  },
  {
    ...
    description: "Se actualizaron las notas de facturación de la instalación.",
    category: "FINANCE",
    visibility: "FINANCE_ONLY",
    action: "UPDATED",
  },
  {
    ...
    description:
      "Se actualizó el motivo de bloqueo de facturación de la instalación.",
    category: "FINANCE",
    visibility: "FINANCE_ONLY",
    action: "UPDATED",
  },
  ...
  },
  {
    ...
    title: "Dirección de instalación actualizada",
    description: "Se actualizó la dirección de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
  ...
  {
    fieldName: "city",
    title: "Ciudad de instalación actualizada",
    description: "Se actualizó la ciudad de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
  {
    ...
    title: "Provincia de instalación actualizada",
    description: "Se actualizó la provincia de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
  {
    ...
    title: "Cantón de instalación actualizado",
    description: "Se actualizó el cantón de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
  {
    ...
    title: "Distrito de instalación actualizado",
    description: "Se actualizó el distrito de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
  {
    fieldName: "latitude",
    title: "Latitud de instalación actualizada",
    description: "Se actualizó la latitud de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
    getValue: (source) =>
      source ? decimalToNumber(source.latitude as never) : null,
  },
  {
    fieldName: "longitude",
    title: "Longitud de instalación actualizada",
    description: "Se actualizó la longitud de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
    getValue: (source) =>
      source ? decimalToNumber(source.longitude as never) : null,
  },
  {
    fieldName: "location_notes",
    title: "Notas de ubicación actualizadas",
    description: "Se actualizaron las notas de ubicación de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
  {
    ...
    description: "Se actualizó el punto de referencia de la instalación.",
    category: "INSTALLATION",
    visibility: "PUBLIC_INTERNAL",
    action: "UPDATED",
  },
...
export async function updateInstallationByIdService(
  ...
  const trackedChanges = [
    ...
    },
    {
      ...
      old_value: decimalToNumber(existing.final_amount),
      new_value: decimalToNumber(updated.final_amount),
    },
    {
      field_name: "cost_amount",
      old_value: decimalToNumber(existing.cost_amount),
      new_value: decimalToNumber(updated.cost_amount),
    },
    {
      field_name: "billing_status",
      old_value: existing.billing_status,
      new_value: updated.billing_status,
    },
    {
      field_name: "billing_notes",
      old_value: existing.billing_notes,
      new_value: updated.billing_notes,
    },
    {
      field_name: "billing_block_reason",
      old_value: existing.billing_block_reason,
      new_value: updated.billing_block_reason,
    },
    {
    ...
    },
    {
      ...
      old_value: existing.address_line,
      new_value: updated.address_line,
    },
    {
      field_name: "zone",
    ...
    {
      field_name: "city",
      old_value: existing.city,
      new_value: updated.city,
    },
    {
      field_name: "admin_level_1",
      old_value: existing.admin_level_1,
      new_value: updated.admin_level_1,
    },
    {
      field_name: "admin_level_2",
      old_value: existing.admin_level_2,
      new_value: updated.admin_level_2,
    },
    {
      field_name: "admin_level_3",
      old_value: existing.admin_level_3,
      new_value: updated.admin_level_3,
    },
    {
      field_name: "latitude",
      old_value: decimalToNumber(existing.latitude),
      new_value: decimalToNumber(updated.latitude),
    },
    {
      field_name: "longitude",
      old_value: decimalToNumber(existing.longitude),
      new_value: decimalToNumber(updated.longitude),
    },
    {
      field_name: "location_notes",
      old_value: existing.location_notes,
      new_value: updated.location_notes,
    },
    {
      field_name: "reference_point",
      old_value: existing.reference_point,
      new_value: updated.reference_point,
    },
    {
