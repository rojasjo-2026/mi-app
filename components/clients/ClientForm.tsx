...
function getDefaultIdentificationType(
...
function normalizeIdentificationValue(value: string) {
  return value.trim().replace(/[\s-]/g, "");
}

function getIdentificationHelpText(identificationType: string) {
...
function getReadableFieldName(field?: string) {
  switch (field) {
...
function getReadableValidationError(error: string) {
  switch (error) {
